...
The assemblies are also aligned to the ES114 reference with `minimap2` in order to put the contigs in order prior to generating an MSA file across all the de novo assemblies with `mafft`. This is done in the script `align_asms.sh`
